...
%PY% scripts\launch_campaign.py --workers 8 --seeds 16..31 --tag rnd4v8c --regime MATE-4v8-9-v0 --steps 30000 --eval-episodes 3 --eval-every 10000 --reward rnd --reward-window 20 --env-reward-clip 8 --no-baselines
