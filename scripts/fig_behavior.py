...
Usage:
    .venv\\Scripts\\python.exe scripts\\fig_behavior.py --tag chao8v8 \\
        ...
        --cap 600 --out results/fig_behavior.pdf --dpi 200
"""
...
from project09.environment.mate_env import make_mate, state_arrays  # noqa: E402
...
def main():
    ...
    ap.add_argument("--out", default="results/fig_behavior.pdf")
