...
from src.config import BASE_SEED, DEFAULT_REGIME, SEED_STRIDE  # noqa: E402
...
def main():
    ...
    print(f"{'counter':<15}{'mean_visit':>11}{'mean_F1':>9}{'mean_F2':>9}"
          f"{'frac_cap':>10}{'vs_greedy(max_|d|)':>20}")

    data = {}
    for k in ks:
        seqs = [rollout_counts(regime, sd, k, steps) for sd in seeds]
